...
export class OrderFiltersComponent implements OnInit, OnDestroy {
  ...
  constructor() {
    ...
    this.filterForm = this.fb.group({
      registration_date_start: [firstDay],
      registration_date_end: [lastDay],
      status: [null],
  ...
  applyFilters(): void {
    ...
    const filters: OrderFilterCriteria = {
      registration_date_start: formValues.registration_date_start
        ? this.datePipe.transform(formValues.registration_date_start, 'yyyy-MM-dd')
        : null,
      registration_date_end: formValues.registration_date_end
        ? this.datePipe.transform(formValues.registration_date_end, 'yyyy-MM-dd')
        : null,
  ...
  clearFilters(): void {
    this.filterForm.reset({
      registration_date_start: null,
      registration_date_end: null,
      status: null,
      search_term: '',
    });
  }
