...
export class OrderService {
  ...
  getRegisteredOrders(
    ...
    if (filters) {
      if (filters.registration_date_start) {
        params = params.set('start_date', filters.registration_date_start);
      }
      if (filters.registration_date_end) {
        params = params.set('end_date', filters.registration_date_end);
      }
      if (filters.status) {
        params = params.set('status', filters.status);
      }
