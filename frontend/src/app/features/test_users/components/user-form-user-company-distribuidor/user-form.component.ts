...
import { UserFormData } from '../user-display/user-display.component';
...
export class UserFormComponent implements OnInit {
  ...
  get isCompanyRole(): boolean {
    return (
      this.userForm.get('role')?.value === UserRole.COMPANY ||
      this.userForm.get('role')?.value === UserRole.EMPRESA_DISTRIBUIDOR
    );
  }
